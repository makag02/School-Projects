...
public class SnapShop extends JFrame {
	...
	public SnapShop() {
		...
		try {
			...
			throw new RuntimeException("Could not set the default look and feel");
		}
	...
	private class FileLoader extends JPanel implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				JOptionPane.showMessageDialog(s, "Could not open file", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	...
	private class RenderingDialog extends Frame {
		public RenderingDialog(JFrame parent) {
			...
			Label label = new Label("Applying filter, please wait...", JLabel.CENTER);
	...
	/**
	 * Add a filter to the SnapShop interface. Creates a button and links it to the
	 * filter.
	 * 
